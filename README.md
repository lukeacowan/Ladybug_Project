...
## Introduction
- We will provide a data dictionary, describe the cleaning process, provide analysis, and state our conclusions for the two ladybug data sets.
---
...
- In order to create our first visualization, we stareted by joining the two ladybug data sets as follows:
```
...
- As shown in the graph, Harmonia axridis and Coleomegilla maculata were the most commonly found ladybugs among the four Augustana students, being found in (nearly) all possible locations. 
...
3. Augustana Collector Visualization
- After cleaning the joined data frame to avoid repeats due to inconcistent formatting, we used the following code to identify how many ladybugs the members of the Augustana Biology department collected from each species.
```
...
- Veronica - 113
<br/>
- Each collector found (almost) all of the listed ladybug species and there was typically little variance in the number of ladybugs collected for a certain species from student to student.

4. Ladybug by Decade Visualization
...
- 2020s - 3
<br/>
- The sample sizes in the decades leading up to the 2020s--the 2000s and 2010s especially--are not substantial enough to draw solid conclusions.
- Values shown for the 2000s and 2010s are not represenative of the actual distribution of species for the reason listed above, so those dramatic shifts in trends should be ignored.
- However, we found this graph insightful because it shows how rapidly the Harmonia axyridis grew to be the most dominant species on the Illinois-Iowa border. We believe this trend began during the 2000s and/or the 2010s, but there was not enough data to substantiate or deny this hypothesis.
- The reduced proportion of native ladybug species relative to the entire sample set, not including Coleomegilla maculata, led us to conclude that Harmonia axyridis ladybugs are outcompeting the other species for food and resources.  

5. Average Number of Ladybugs Found per Epithet T-Test
...
- Conclusion: Because the p-value of our test (0.805) is greater than the significant threshold, we fail to reject the null hypothesis of the test. There is insufficient evidence to conclude thatmean number of ladybugs found per epithet is different from 40 ladybugs.
---

## Conclusion :lady_beetle:
1. Harmonia axyridis have overtaken Coleomegilla maculata as the most dominant species of ladybug in recent years.
2. More ladybugs live in unmowed grass habitats than other areas, i.e., agricultural, garden, industrial, etc.
3. The greatest number of ladybug samples were collected in Scott County, Iowa.
4. All members of the Biology department collected a large and diverse samples of ladybugs in 2021.
